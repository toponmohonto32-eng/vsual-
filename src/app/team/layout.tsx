...
const navItems = [
  ...
  { href: "/team/campaigns", label: "Campaigns", icon: Megaphone },
]
        ...
        <nav className="flex-1 py-4">
          {navItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-purple-500/10 transition-colors group"
            >
            ...
            <nav className="space-y-2">
              {navItems.map((item) => (
                <Link
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-white hover:bg-purple-500/10 transition-colors"
                >
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        ...
        <header className="h-16 bg-[#12121a]/50 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 lg:px-6 mt-16 lg:mt-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-400 text-sm">Team Access</span>
          </div>
